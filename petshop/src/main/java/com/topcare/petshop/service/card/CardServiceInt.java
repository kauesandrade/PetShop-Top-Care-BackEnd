...
public interface CardServiceInt {
    ...
    /**
     * Retorna uma lista de cartões pertencentes a um usuário específico.
     *
     * @param userId ID do usuário cujos cartões serão retornados.
     * @return Lista de cartões do usuário.
     */
    List<Card> getCardsOfUser(Long userId);

    /**
     * Retorna uma lista de DTOs de cartões pertencentes a um usuário específico.
     *
     * @param userId ID do usuário cujos cartões serão retornados.
     * @return Lista de DTOs de cartões do usuário.
     */
